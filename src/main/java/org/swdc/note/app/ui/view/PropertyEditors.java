...
import org.swdc.note.app.configs.Importer;
...
public class PropertyEditors {
    ...
    public static PropertyEditor<?> createFileImportableEditor(ConfigProperty property, UIConfig config) {
        ...
        buttonImport.setFont(UIConfig.getFontIconSmall());
        buttonImport.setText(UIConfig.getAwesomeMap().get("folder_open") + "");
        ...
        if (propData.importer() != Importer.class) {
            try {
                Importer importer = propData.importer().newInstance();
                buttonImport.setOnAction(e -> {
                    ...
                    File file = chooser.showOpenDialog(GUIState.getStage());
                    try {
                        importer.install(file);
                        files.clear();
    ...
    public static PropertyEditor<?> createFolderImportableEditor(ConfigProperty property,UIConfig config) {
        ConfigProp propData = property.getPropData();
        ObservableList<String> files = FXCollections.observableArrayList();
